<template>
    <section class="swift-widget">
        <div class="swift-widget_block">
            <div class="conversation_exit">
                <span>{{ __("swift-widget", "Close") }}</span>
                <svg class="swift-widget_cross" xmlns="http://www.w3.org/2000/svg" width="14.483" height="14.483" viewBox="0 0 14.483 14.483">
                    <path id="Path_663" data-name="Path 663" d="M13.994,2.854,9.605,7.243l4.388,4.389A1.671,1.671,0,1,1,11.631,14L7.241,9.607,2.852,14A1.671,1.671,0,0,1,.49,11.632L4.878,7.243.489,2.854A1.671,1.671,0,0,1,2.852.491L7.241,4.88,11.63.491a1.671,1.671,0,0,1,2.363,2.364Z" transform="translate(0.001 -0.002)" fill="#c5daf7"/>
                </svg>
            </div>
            <img class="swift-widget_img" src="/img/illustration/viber.svg" alt="SWIFT Viber">
            <div class="swift-widget_text">
                Suntem și pe Viber, puteți să ne lăsați numărul de contact iar noi la rândul nostru venim cu un răspuns în scurt timp.
            </div>
            <div class="swift-widget_button button mod-blue">{{ __("swift-widget", "Write in Viber") }}</div>
            <div class="swift-widget_links">
                <svg class="links_icon" id="call" xmlns="http://www.w3.org/2000/svg" width="36.383" height="36.673" viewBox="0 0 36.383 36.673">
                    <g transform="translate(0 0)">
                        <path id="Path_202" data-name="Path 202" d="M7.331,36.673A2.938,2.938,0,0,1,4.4,33.738v-4.3A18.088,18.088,0,0,1,.665,15.724a18.2,18.2,0,0,1,36.1,4.549A18.169,18.169,0,0,1,11.554,34.907l-2.91,1.454A2.938,2.938,0,0,1,7.331,36.673ZM16.608,2.734A15.7,15.7,0,0,0,3.24,16.064,15.516,15.516,0,0,0,6.7,28.149a1.3,1.3,0,0,1,.3.831v4.758a.333.333,0,0,0,.484.3l3.461-1.729a1.3,1.3,0,0,1,1.133-.014A15.586,15.586,0,1,0,16.608,2.734Zm-.166-1.289h0Zm0,0" transform="translate(-0.5 0)" />
                        <g transform="translate(11.469 10.612)">
                            <path id="XMLID_10_" d="M5.165,26.327c.071-.054.145-.111.214-.166.365-.294.754-.565,1.13-.827l.234-.163a2.332,2.332,0,0,1,1.323-.5,1.715,1.715,0,0,1,1.427.9.758.758,0,0,0,.651.4,1.293,1.293,0,0,0,.524-.132,6.311,6.311,0,0,0,3.3-3.211c.307-.689.207-1.14-.332-1.506a1.525,1.525,0,0,1-.837-1.337,7.634,7.634,0,0,1,2.687-3.664,1.525,1.525,0,0,1,1.037,0,3,3,0,0,1,1.868,1.537,2.856,2.856,0,0,1-.041,2.305,18.6,18.6,0,0,1-4.081,6.213,19.784,19.784,0,0,1-6.192,4.111,3.429,3.429,0,0,1-.612.182c-.057.013-.106.024-.142.033a.238.238,0,0,1-.06.008H7.241a3.513,3.513,0,0,1-2.917-2.22C3.957,27.25,4.627,26.738,5.165,26.327Z" transform="translate(-4.219 -16.025)" />
                        </g>
                    </g>
                </svg>
                <svg class="links_icon" id="chat" xmlns="http://www.w3.org/2000/svg" width="36.383" height="36.673" viewBox="0 0 36.383 36.673">
                    <path id="Path_202" data-name="Path 202" d="M7.331,36.673A2.938,2.938,0,0,1,4.4,33.738v-4.3A18.088,18.088,0,0,1,.665,15.724a18.2,18.2,0,0,1,36.1,4.549A18.169,18.169,0,0,1,11.554,34.907l-2.91,1.454A2.938,2.938,0,0,1,7.331,36.673ZM16.608,2.734A15.7,15.7,0,0,0,3.24,16.064,15.516,15.516,0,0,0,6.7,28.149a1.3,1.3,0,0,1,.3.831v4.758a.333.333,0,0,0,.484.3l3.461-1.729a1.3,1.3,0,0,1,1.133-.014A15.586,15.586,0,1,0,16.608,2.734Zm-.166-1.289h0Zm0,0" transform="translate(-0.5 0)"/>
                    <g id="speech-bubbles-comment-option" transform="translate(8.182 -43.95)">
                        <g id="Group_241" data-name="Group 241" transform="translate(0 54.804)">
                            ...
                            <path id="Path_506" data-name="Path 506" d="M187.687,164.343a4.175,4.175,0,0,0-.043-4.862,6.341,6.341,0,0,0-2.182-1.9,5.505,5.505,0,0,1-.471,4.343,7.161,7.161,0,0,1-2.054,2.268,9.472,9.472,0,0,1-2.824,1.38,11.3,11.3,0,0,1-3.305.481q-.321,0-.941-.043a8.989,8.989,0,0,0,5.049,1.412,10.747,10.747,0,0,0,1.883-.171,8.543,8.543,0,0,0,3.894,1.541.323.323,0,0,0,.235-.075.4.4,0,0,0,.139-.235c0-.043,0-.066.011-.07s.009-.027-.005-.069l-.021-.064-.027-.053a.511.511,0,0,0-.037-.059.458.458,0,0,0-.043-.053c-.01-.011-.026-.029-.048-.053l-.043-.048q-.053-.064-.246-.268t-.278-.315q-.086-.112-.241-.31a2.7,2.7,0,0,1-.267-.412q-.112-.214-.219-.471A6.277,6.277,0,0,0,187.687,164.343Z" transform="translate(-169.277 -153.726)" />
                        </g>
                    </g>
                </svg>
                <svg id="messenger" class="links_icon" xmlns="http://www.w3.org/2000/svg" width="36.383" height="36.673" viewBox="0 0 36.383 36.673">
                    <path id="Path_202" data-name="Path 202" d="M7.331,36.673A2.938,2.938,0,0,1,4.4,33.738v-4.3A18.088,18.088,0,0,1,.665,15.724a18.2,18.2,0,0,1,36.1,4.549A18.169,18.169,0,0,1,11.554,34.907l-2.91,1.454A2.938,2.938,0,0,1,7.331,36.673ZM16.608,2.734A15.7,15.7,0,0,0,3.24,16.064,15.516,15.516,0,0,0,6.7,28.149a1.3,1.3,0,0,1,.3.831v4.758a.333.333,0,0,0,.484.3l3.461-1.729a1.3,1.3,0,0,1,1.133-.014A15.586,15.586,0,1,0,16.608,2.734Zm-.166-1.289h0Zm0,0" transform="translate(-0.5 0)"/>
                    <path id="Path_203" data-name="Path 203" d="M126.923,191.323l5.965-8.489a.832.832,0,0,1,1.222-.253l4,3a.832.832,0,0,0,.928.048l4.866-3.439a.832.832,0,0,1,1.173,1.086l-4.817,8.334a.832.832,0,0,1-1.173.341l-5.334-3.2a.833.833,0,0,0-.8-.031l-4.929,3.764A.832.832,0,0,1,126.923,191.323Zm0,0" transform="translate(-117.762 -169.022)" />
                </svg>
                <svg id="telegram" class="links_icon" xmlns="http://www.w3.org/2000/svg" width="31.332" height="31.582" viewBox="0 0 31.332 31.582">
                ...
                <svg id="mail" class="links_icon" xmlns="http://www.w3.org/2000/svg" width="36.383" height="36.673" viewBox="0 0 36.383 36.673">
                    <path id="Path_202" data-name="Path 202" d="M7.331,36.673A2.938,2.938,0,0,1,4.4,33.738v-4.3A18.088,18.088,0,0,1,.665,15.724a18.2,18.2,0,0,1,36.1,4.549A18.169,18.169,0,0,1,11.554,34.907l-2.91,1.454A2.938,2.938,0,0,1,7.331,36.673ZM16.608,2.734A15.7,15.7,0,0,0,3.24,16.064,15.516,15.516,0,0,0,6.7,28.149a1.3,1.3,0,0,1,.3.831v4.758a.333.333,0,0,0,.484.3l3.461-1.729a1.3,1.3,0,0,1,1.133-.014A15.586,15.586,0,1,0,16.608,2.734Zm-.166-1.289h0Zm0,0" transform="translate(-0.5 0)"/>
                    <g id="close-envelope" transform="translate(8.469 9.527)">
                        <g id="Group_138" data-name="Group 138" transform="translate(0 2)">
                            <path id="Path_208" data-name="Path 208" d="M9.624,9.6,7.212,7.484.316,13.4a1.412,1.412,0,0,0,.962.377H17.97a1.4,1.4,0,0,0,.958-.377L12.036,7.484Z" transform="translate(0.124 0.153)"/>
                            <path id="Path_209" data-name="Path 209" d="M18.931,2.377A1.4,1.4,0,0,0,17.969,2H1.277a1.4,1.4,0,0,0-.959.38l9.305,7.975Z" transform="translate(0.125 -2)"/>
                            <path id="Path_210" data-name="Path 210" d="M0,2.878v11.57L6.73,8.728Z" transform="translate(0 -1.655)"/>
                            <path id="Path_211" data-name="Path 211" d="M9.167,8.729l6.73,5.719V2.875Z" transform="translate(3.599 -1.656)"/>
                        </g>
                    </g>
                </svg>
            </div>
