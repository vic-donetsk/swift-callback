        ...
        <div class="swift-widget_block" >
            ...
            <div class="swift-widget_lower-section" v-if="status != 3">
                <div class="swift-widget_links">
                    ...
                    <svg class="links_icon" id="chat" @click="chat" xmlns="http://www.w3.org/2000/svg" width="36.383"
                         height="36.673"
                         viewBox="0 0 36.383 36.673">
                        <path id="Path_202" data-name="Path 202"
                              d="M7.331,36.673A2.938,2.938,0,0,1,4.4,33.738v-4.3A18.088,18.088,0,0,1,.665,15.724a18.2,18.2,0,0,1,36.1,4.549A18.169,18.169,0,0,1,11.554,34.907l-2.91,1.454A2.938,2.938,0,0,1,7.331,36.673ZM16.608,2.734A15.7,15.7,0,0,0,3.24,16.064,15.516,15.516,0,0,0,6.7,28.149a1.3,1.3,0,0,1,.3.831v4.758a.333.333,0,0,0,.484.3l3.461-1.729a1.3,1.3,0,0,1,1.133-.014A15.586,15.586,0,1,0,16.608,2.734Zm-.166-1.289h0Zm0,0"
                    ...
                    <svg id="messenger" class="links_icon" @click="messenger" xmlns="http://www.w3.org/2000/svg"
                         width="36.383" height="36.673"
                         viewBox="0 0 36.383 36.673">
                        <path id="Path_202" data-name="Path 202"
                              d="M7.331,36.673A2.938,2.938,0,0,1,4.4,33.738v-4.3A18.088,18.088,0,0,1,.665,15.724a18.2,18.2,0,0,1,36.1,4.549A18.169,18.169,0,0,1,11.554,34.907l-2.91,1.454A2.938,2.938,0,0,1,7.331,36.673ZM16.608,2.734A15.7,15.7,0,0,0,3.24,16.064,15.516,15.516,0,0,0,6.7,28.149a1.3,1.3,0,0,1,.3.831v4.758a.333.333,0,0,0,.484.3l3.461-1.729a1.3,1.3,0,0,1,1.133-.014A15.586,15.586,0,1,0,16.608,2.734Zm-.166-1.289h0Zm0,0"
                              transform="translate(-0.5 0)"/>
                    ...
                    <svg id="telegram" class="links_icon" @click="telegram" xmlns="http://www.w3.org/2000/svg"
                         width="31.332" height="31.582"
                    ...
                    <svg id="vk" class="links_icon" @click="vk" xmlns="http://www.w3.org/2000/svg" width="31.332"
                         height="31.582"
                         viewBox="0 0 31.332 31.582">
                    ...
                    <svg id="viber" class="links_icon" @click="viber" xmlns="http://www.w3.org/2000/svg" width="31.332"
                         height="31.582"
                         viewBox="0 0 31.332 31.582">
                        <g transform="translate(0)">
                            <path id="Path_202" data-name="Path 202"
                    ...
                    <svg id="whatsapp" class="links_icon" @click="whatsapp" xmlns="http://www.w3.org/2000/svg"
                         width="31.332" height="31.582"
                         viewBox="0 0 31.332 31.582">
                        <g transform="translate(0)">
                            <path id="Path_202" data-name="Path 202"
                    ...
                    <svg id="mail" class="links_icon" @click="mail" xmlns="http://www.w3.org/2000/svg" width="36.383"
                         height="36.673"
                         viewBox="0 0 36.383 36.673">
                        <path id="Path_202" data-name="Path 202"
                              d="M7.331,36.673A2.938,2.938,0,0,1,4.4,33.738v-4.3A18.088,18.088,0,0,1,.665,15.724a18.2,18.2,0,0,1,36.1,4.549A18.169,18.169,0,0,1,11.554,34.907l-2.91,1.454A2.938,2.938,0,0,1,7.331,36.673ZM16.608,2.734A15.7,15.7,0,0,0,3.24,16.064,15.516,15.516,0,0,0,6.7,28.149a1.3,1.3,0,0,1,.3.831v4.758a.333.333,0,0,0,.484.3l3.461-1.729a1.3,1.3,0,0,1,1.133-.014A15.586,15.586,0,1,0,16.608,2.734Zm-.166-1.289h0Zm0,0"
